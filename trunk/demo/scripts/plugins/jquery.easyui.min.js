...
var _18a=$("<div class=\"panel-header d-head\"><i class=\"sprite\"></i><div class=\"panel-title repeat d-head-box\">"+opts.title+"</div><s class=\"sprite\"></s></div>").prependTo(_189);
if(opts.iconCls){
...
var win=$(_1d4).panel($.extend({},_1d5.options,{border:false,doSize:true,closed:true,cls:"window dialog",headerCls:"window-header",bodyCls:"window-body "+(_1d5.options.noheader?"window-body-noheader":""),onBeforeDestroy:function(){
...
}})).after('<div class="d-bottom"><i class="sprite"></i><div class="d-bottom-box"></div><s class="sprite"></s></div>');
